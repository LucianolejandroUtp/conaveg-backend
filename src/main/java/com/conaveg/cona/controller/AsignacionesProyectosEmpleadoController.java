...
public class AsignacionesProyectosEmpleadoController {
    ...
    @Operation(summary = "Listar asignaciones", description = "Obtiene todas las asignaciones de empleados a proyectos.")
    ...
    @GetMapping("/{id}")
    public ResponseEntity<AsignacionesProyectosEmpleado> getAsignacionesProyectosEmpleadoById(
    ...
    @PostMapping
    public ResponseEntity<AsignacionesProyectosEmpleado> createAsignacionesProyectosEmpleado(
            @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "Objeto asignación a crear")
            @RequestBody AsignacionesProyectosEmpleado asignacion) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<AsignacionesProyectosEmpleado> updateAsignacionesProyectosEmpleado(
